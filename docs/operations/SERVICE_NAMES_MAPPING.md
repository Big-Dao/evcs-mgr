...
> **版本**: v1.0 | **最后更新**: 2025-12-18 | **维护者**: 运维负责人 | **状态**: 活跃
>
> 🔁 **用途**: 统一 Docker Compose / Kubernetes / 代码中的服务命名
...
| 服务名 | 描述 | 内部端口 | 外部端口 | 备注 |
|--------|------|----------|----------|------|
| `postgres` | PostgreSQL数据库 | 5432 | 5432 | 基础设施 |
| `redis` | Redis缓存 | 6379 | 6379 | 基础设施 |
| `rabbitmq` | RabbitMQ消息队列 | 5672/15672 | 5672/15672 | 基础设施 |
| `eureka` | 服务注册中心 | 8761 | 8761 | 微服务核心 |
| `config` | 配置服务器 | 8888 | 8888 | 微服务核心 |
| `gateway` | API网关 | 8080 | 8080 | **核心路由** |
| `auth` | 认证服务 | 8081 | 8081 | 用户认证 |
| `station` | 站点管理服务 | 8082 | 8082 | 业务服务 |
| `tenant` | 租户管理服务 | 8083 | 8083 | 业务服务 |
| `order` | 订单服务 | 8084 | 8084 | 业务服务 |
| `payment` | 支付服务 | 8085 | 8085 | 业务服务 |
| `protocol` | 协议处理服务 | 8086 | 8086 | 协议支持 |
| `monitoring` | 监控服务 | 9090 | 9090 | 系统监控 |
| `admin` | 前端管理界面 | 80 | 80 | Web界面 |
...
| protocol | 8086 | 8086 | 协议服务 |
| monitoring | 9090 | 9090 | 监控服务 |
