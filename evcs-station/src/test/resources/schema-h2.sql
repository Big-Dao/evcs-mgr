...
-- Charger Connector Table (per-gun state)
CREATE TABLE IF NOT EXISTS charger_connector (
    charger_connector_id BIGINT GENERATED BY DEFAULT AS IDENTITY,
    tenant_id BIGINT NOT NULL,
    ...
    last_meter_time TIMESTAMP,
    last_voltage DECIMAL(10,2),
    last_current DECIMAL(10,2),
    last_power DECIMAL(12,4),
    last_soc DECIMAL(5,2),
    last_energy DECIMAL(12,4),
    create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    update_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    create_by BIGINT,
    update_by BIGINT,
...
-- Charger Connector Session Table
CREATE TABLE IF NOT EXISTS charger_connector_session (
    charger_connector_session_id BIGINT GENERATED BY DEFAULT AS IDENTITY,
    tenant_id BIGINT NOT NULL,
    charger_id BIGINT NOT NULL,
    connector_no INTEGER NOT NULL,
    ...
    deleted INTEGER DEFAULT 0,
    version INTEGER DEFAULT 1,
    PRIMARY KEY (charger_connector_session_id)
);

CREATE INDEX IF NOT EXISTS idx_connector_session_list
    ON charger_connector_session(tenant_id, charger_id, connector_no, start_time);

-- Charger Connector Curve Point Table
CREATE TABLE IF NOT EXISTS charger_connector_curve_point (
    charger_connector_curve_point_id BIGINT GENERATED BY DEFAULT AS IDENTITY,
    tenant_id BIGINT NOT NULL,
    charger_id BIGINT NOT NULL,
    connector_no INTEGER NOT NULL,
    session_id VARCHAR(64) NOT NULL,
    ...
    deleted INTEGER DEFAULT 0,
    version INTEGER DEFAULT 1,
    PRIMARY KEY (charger_connector_curve_point_id)
);
