...
public class AlipayReconciliationService {
     ...
     * # 支付宝交易明细账单
     * # 账单时间：2024-11-02
     * # 商户订单号,支付宝交易号,业务类型,商品名称,创建时间,完成时间,门店编号,门店名称,操作员,终端号,对方账号,订单金额,
     * # 商家红包,集分宝,支付宝红包,商家优惠,商家优惠金额,券核销金额,券名称,卡消费金额,卡品牌,分期付款金额,分期付款手续费,分期付款净额,退款金额,资金服务费,实收金额,备注,分润明细
     */
